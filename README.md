# 🎨 AI Creative Generator Agent

Generate ad images and videos with AI (Imagen 4, Veo, Flux) via MCP.

 `ai-creative` `image-generation` `video-generation` `mcp` `ai-agents`

---

## What is this?

Open this repo in **Amp**, **Cursor**, or **VS Code** and your AI agent can immediately manage AI Creative Generator — no SDK to install, no dependencies. The [Synter MCP server](https://github.com/Synter-Media-AI/mcp-server) is already configured.
...
> Generate a 1200x628 display ad image for my SaaS product

> Create a YouTube video ad

> Generate platform-specific image sizes

> Create a competitor-inspired ad creative

> Upload generated image as a Google Ads asset
...
2. Click "Connect" next to AI Creative Generator
